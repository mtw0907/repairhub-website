  ...
  return (
    <>
            ...
            <Link
              ...
              className={
                active
                  ...
                  : "flex items-center gap-2 rounded-full px-3.5 py-2 text-base font-medium text-neutral-600 transition-colors hover:bg-surface-muted hover:text-primary dark:text-neutral-400 dark:hover:bg-neutral-900 lg:px-4"
              }
            >
      ...
      <button
        ...
        className="order-last flex h-10 w-10 shrink-0 items-center justify-center rounded-full text-neutral-600 transition-colors hover:bg-surface-muted hover:text-primary dark:text-neutral-300 dark:hover:bg-neutral-900 md:hidden"
      >
                ...
                <Link
                  ...
                  className={
                    active
                      ...
                      : "flex items-center gap-3 rounded-xl px-4 py-3 text-base font-medium text-neutral-700 transition-colors hover:bg-surface-muted dark:text-neutral-300 dark:hover:bg-neutral-900"
                  }
                >
