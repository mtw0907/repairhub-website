                    ...
                    return (
                      <li key={label}>
                        {href ? (
                          <Link
                            href={href}
                            className="group flex items-center gap-2 rounded-xl px-3 py-3 text-[15px] font-medium text-neutral-700 transition-colors hover:bg-accent/10 hover:text-accent dark:text-neutral-300 dark:hover:bg-accent/15 dark:hover:text-accent"
                          >
