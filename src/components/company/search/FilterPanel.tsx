      ...
      <div className="max-h-[85vh] w-full max-w-md overflow-y-auto rounded-t-3xl bg-white p-5 shadow-2xl dark:bg-neutral-900 sm:rounded-3xl">
        <div className="mb-4 flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex h-8 w-8 items-center justify-center rounded-full text-neutral-400 hover:border-accent/50 hover:bg-accent/10 hover:text-accent dark:hover:border-accent/40 dark:hover:bg-accent/15 dark:hover:text-accent"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        <div className="mt-6 flex gap-2">
          <button
            ...
            className="flex-1 rounded-xl border border-neutral-200 py-2.5 text-sm font-medium text-neutral-600 transition-colors hover:border-accent/50 hover:bg-accent/10 hover:text-accent dark:border-neutral-700 dark:text-neutral-300 dark:hover:border-accent/40 dark:hover:bg-accent/15 dark:hover:text-accent"
          >
            초기화
          </button>
          <button
